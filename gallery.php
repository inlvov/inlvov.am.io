...
include_once "gallery_content.php";
...
var splide = new Splide( '#first-gall', {
   perPage: 2,
  rewind : true
} );

var splide_s = new Splide( '#sec-gall', {
   perPage: 2,
  rewind : true
} );

var splide_3 = new Splide( '#third-gall', {
   perPage: 2,
  rewind : true
} );


var splide_4 = new Splide( '#four-gall', {
   perPage: 2,
  rewind : true
} );

var splide_5 = new Splide( '#five-gall', {
   perPage: 2,
  rewind : true
} );

var splide_6 = new Splide( '#six-gall', {
   perPage: 2,
  rewind : true
} );

var splide_7 = new Splide( '#seven-gall', {
   perPage: 2,
  rewind : true
} );
